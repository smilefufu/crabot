...
- 这是 Manager/Worker 双 Agent 架构 P3 的实现遗漏修订，不是新增设计：正式协议已更新到 `protocol-agent-v3.md` v3.0.7，原 split spec §8.2 与实施计划 `2026-08-09-worker-mcp-capability-wiring-plan.md` 已确认并推送文档仓（基础修订 `ebe076b` / `8c9f917`，review 收口至 `e48c496`）。
