...
class MemoryModule:
    ...
    async def _dispatch(self, method: str, params: Dict[str, Any]) -> Any:
        ...
        handlers: Dict[str, Callable] = {
            ...
            "promote_inbox_entry": self._lt_v2_rpc.promote_inbox_entry,
            "preview_historical_inbox": self._lt_v2_rpc.preview_historical_inbox,
            "migrate_historical_inbox_batch": self._lt_v2_rpc.migrate_historical_inbox_batch,
